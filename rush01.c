...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/14 18:30:24 by magrab            #+#    #+#             */
/*   Updated: 2019/07/14 18:30:26 by magrab           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			check_valid(int *tab, int *cote)
{
	...
	x = -1;
	if (check_up(tab, cote[0], 0))
		return (0);
	if (check_up(tab, cote[1], 1))
		return (0);
	if (check_up(tab, cote[2], 2))
		return (0);
	if (check_up(tab, cote[3], 3))
		return (0);
	if (check_down(tab, cote[4], 12))
			return (0);
	if (check_down(tab, cote[5], 13))
		return (0);
	if (check_down(tab, cote[6], 14))
			return (0);
	if (check_down(tab, cote[7], 15))
		return (0);
	if (check_left(tab, cote[8], 0))
		return (0);
	if (check_left(tab, cote[9], 4))
		return (0);
	if (check_left(tab, cote[10], 8))
		return (0);
	if (check_left(tab, cote[11], 12))
		return (0);
